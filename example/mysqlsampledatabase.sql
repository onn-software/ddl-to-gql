...
CREATE TABLE `customers` (
  ...
  `1addressLine1` varchar(50) NOT NULL,
  `2addressLine2` varchar(50) DEFAULT NULL,
...
insert  into `customers`(`customerNumber`,`customerName`,`contactLastName`,`contactFirstName`,`phone`,`1addressLine1`,`2addressLine2`,`city.name`,`state`,`postalCode`,`country`,`salesRepEmployeeNumber`,`creditLimit`) values
